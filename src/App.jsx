...
const App = () => {
  ...
  console.log(city)
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-700 p-5">
      ...
      <div className="mt-5">
        <form onSubmit={submitCity} className="flex space-x-3">
          ...
          <button type="submit" className="bg-zinc-500 hover:bg-zinc-300 font-bold py-2 px-4 rounded text-black">Search</button>
        </form>
      </div>
